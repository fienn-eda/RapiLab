...
- [ ] **`lifetime_refreshes`가 트렁크에 오면 여섯을 고친다** — 측정치는 코어 48.89px ·
      DEF 8000 · 180초, 셸은 후보 티어별 고정:
      **라플라스 본인 +13.13% / 덱 +2.17%** · **줄리아 +9.22% / +1.86%** ·
      모더니아 +2.95% / +1.33% · 라플라스 시그 +2.57% / +0.63% ·
