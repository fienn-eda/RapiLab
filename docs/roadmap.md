...
- [ ] **To-Do: 스노우화이트 잔여 +0.539B (1.320x) — 여전히 절대오차 1위.**
      ...
      **따라서 그녀의 1.320x는 어떤 버프 상태에서도 발당 데미지가 아니다.** 다음은
      180초에 걸친 **가동률·발수**, 또는 **덱4 자체의 버퍼**다 — 볼륨 1.245 · 민트 1.502 ·
      프리카 1.353으로 셋 다 자기 기록 대비 과대이고, 같은 모양의 측정을 덱4에서 한 판
      뜨면 그들의 버프가 그녀를 부풀리는지 바로 갈린다.
