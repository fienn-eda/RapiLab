...
- [ ] **리틀 머메이드가 0.55x — 이제 최대 이상치.** 차지 버그가 그녀의 과소 모델링을
      정확히 상쇄하고 있었다. SMG이고 변형도 없으므로 순수하게 그녀 인코딩 문제다.
      다음 착수 대상 1순위.
- [ ] **남은 유닛별 이상치 (2026-07-26 실측).** 과소: **리틀 머메이드 0.55x** ·
      나유타 0.79x · 라피 0.79x · 미하라 0.80x · 신데렐라 MG 0.84x · 레이 0.85x ·
      신데렐라 0.88x · liberalio 0.88x. 과대: 에이드 1.57x · 헬름 1.52x ·
      네온:비전아이 1.38x · 민트 1.19x · 아크레인저 1.18x · 볼륨 1.17x.
      총합 **0.96x**, 덱별 덱1 0.98 · 덱2 **0.77** · 덱3 0.98 · 덱4 1.01 · 덱5 1.14.
