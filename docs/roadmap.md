...
- [ ] **To-Do: 절대 오차 순 — 아크레인저 +0.196B · 스노우화이트 +0.185B ·
      아스카 +0.130B · 앵커 +0.125B · 스칼렛 −0.124B.**
      현재: 덱1 1.000 · 덱2 1.019 · 덱3 1.027 · 덱4 1.077 · 덱5 1.039,
      합계 1.023x, **±15% 이내 18/25**, 미달 −0.505B · 과대 +1.311B.
      **이제 남은 것은 과대 쪽이 지배적이다**(+1.311B vs −0.505B).
