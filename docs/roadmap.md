...
- [x] **밀크 딜 이득 재계산: +8.6% → +7.56%**(스톡 장탄 6·재장전 2초, 전투
      30초, 톡톡이 on/off 대조 — 누적배율 4840.0 / 4500.0, 고친
      `audit_milk_tap_fire.py` 실측). 배율 인상(+3%)과 차지대미지 제거가 반대
      방향으로 움직였고, 순효과는 낮아지는 쪽으로 갔다 — **부호는 안
      뒤집혔다.**
...
- [x] **밀크 딜 약 +8.6%**(매거진 케이던스 축, 스톡 장탄 6·재장전 2초 — 등록 전
      ...
      톡톡이 배율 100%→103% + 차지대미지 게이팅으로 이 수치는 +7.56%로
      바뀌었다 — 위 「톡톡이 배율 정정」 절.**
