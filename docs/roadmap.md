...
- [x] **나유타의 합쳐진 넉을 FB 보너스 기준으로 분리 — 완료 (2026-07-26).** Memory
      Incineration 풀차지 넉 530.46%는 원문상 150%("as damage") + 380.46%("as
      **additional** damage") 두 불릿이다. 합산하면 자격 플래그가 하나뿐이라 보너스를
      받아야 할 큰 쪽이 조용히 잃는다. **나유타 0.79x → 0.84x.**
