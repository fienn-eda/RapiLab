...
- **유닛별 연사가 착륙했다 (2026-08-15).** `shot_detail.rate_of_fire`는 유닛별
  ...
  **백엔드 2405 passed / 3 skipped**, 캘리 **1.042x · 19/25 · 무기군 평균 전부
  ...
  - **다음:** 차지 무기의 유닛별 `rate_of_fire`. 신데렐라 180rpm = 0.3333초가
    전역 `CHARGE_INTERVAL_FLOOR_SECONDS`(0.3448)의 유도 실측과 같은 값이다.
...
- [ ] **크라운 1.351x — MG 과대의 진짜 항, 지금 최대 무기군 항.** 램프 곡선이
      상쇄를 걷어낸 뒤 드러난 얼굴이다. 램프 제거 what-if에서 1.341 → 1.345로
      **0.004밖에 안 움직였으므로 원인은 예열이 아니다.** 덱3의 helm-signature
      1.284x가 같은 덱에서 함께 뜬 것도 같이 볼 것.
