...
- [x] **엔진 결함 2건 수정 — 합계 0.936x → 1.011x, 미달이 반감됐다 (2026-07-28).**
      ...
      **현재 캘리브레이션:** 덱1 0.946 · 덱2 0.938 · 덱3 1.100 · 덱4 1.094 · 덱5 1.121,
      **합계 1.011x**, ±15% 이내 10/25, 미달 −1.903B · 과대 +2.302B.
- [ ] **To-Do: 절대 오차 순으로 계속 — 다음은 아스카(+0.540B, 1.192x).**
      `measure_record_calibration.py`가 이제 절대 오차 상위 10개를 출력한다
      (배수 순위로 고르면 로스터의 가장 작은 기여자만 쫓게 된다 — `docs/insights.md`).
      이어지는 순서: 아스카 +0.540B · 아니스:스타 −0.408B · 네온 +0.355B ·
      아크레인저 +0.317B · 리틀머메이드 −0.313B · 리베랄리오 −0.302B.
