...
- [ ] **To-Do: 절대 오차 순 — 네온 +0.377B · 아니스:스타 −0.358B · 아크레인저 +0.196B ·
      스노우화이트 +0.185B · 아스카 +0.130B.**
      현재: 덱1 0.977 · 덱2 1.019 · 덱3 1.027 · 덱4 1.077 · 덱5 1.121,
      합계 1.025x, **±15% 이내 16/25**, 미달 −0.789B · 과대 +1.672B.
      **아니스:스타는 순서와 무관하다**(0.736–0.739x) — 남은 층은 발수/지속 실측뿐.
