...
- [ ] **남은 유닛별 이상치 (2026-07-26 실측, 절대 초과 순).** 과대: 스노우화이트:헤비암즈
      1.44x(+0.74B) · 신데렐라 MG 1.31x(+0.68B) · **프리바티 2.01x**(+0.63B, 비율 최대) ·
      아스카:WILLE 1.18x(+0.51B) · 네온:비전아이 1.38x(+0.47B) · 아크레인저 1.18x ·
      에이드 1.57x/헬름 1.54x/볼륨 1.41x(절대값 작음). 과소: 라피 0.80x · 미하라 0.84x ·
      신데렐라 0.88x. 총합 **1.08x**, 덱별 **0.98~1.17x**.
