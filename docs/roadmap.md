...
- [ ] **To-Do: 절대 오차 순 — 아스카 +0.130B · 스칼렛 −0.124B · 레이 −0.090B ·
      ...
      현재: 덱1 0.990 · 덱2 1.019 · 덱3 1.027 · 덱4 1.004 · 덱5 1.040,
      합계 1.011x, **±15% 이내 21/25**.
      배수 최악은 **에이드 1.498x**(딜레이·발당 모두 실측 완료 → 다른 층) ·
      **볼륨 1.244x**(SMG라 차지 딜레이 설명 밖) · 헬름(애장품) 1.243x(딜레이 추정값).
