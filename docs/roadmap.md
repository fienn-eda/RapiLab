...
- [ ] **To-Do: 절대 오차 순 — 아스카 +0.130B · 앵커 +0.125B · 스칼렛 −0.124B ·
      레이 −0.090B · 미하라 −0.088B.** (아크레인저 +0.196B는 결정에 따라 **제외** —
      `docs/decisions.md` 참조)
      현재: 덱1 1.000 · 덱2 1.019 · 덱3 1.027 · 덱4 **1.004** · 덱5 1.039,
      합계 1.014x, **±15% 이내 20/25**, 미달 −0.508B · 과대 +1.005B.
      **볼륨 1.244x는 SMG**라 차지 딜레이로 설명되지 않는 남은 반례.
