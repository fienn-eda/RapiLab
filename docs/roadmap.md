...
- [x] **Pierce Damage Up이 스킬 딜에 새고 있었다 — 스노우화이트 1.110x → 0.999x (2026-07-28).**
      ...
      **효과:** 덱4 1.077 → **1.033**, 합계 1.023 → **1.018**, 과대 +1.311B → **+1.126B**.
      ...
      애초에 인코딩돼 있지 않아 무관.
- [ ] **To-Do: 절대 오차 순 — 아스카 +0.130B · 앵커 +0.125B · 스칼렛 −0.124B ·
      레이 −0.090B · 민트 +0.089B.** (아크레인저 +0.196B는 결정에 따라 **제외** —
      `docs/decisions.md` 참조)
      현재: 덱1 1.000 · 덱2 1.019 · 덱3 1.027 · 덱4 1.033 · 덱5 1.039,
      합계 1.018x, **±15% 이내 18/25**, 미달 −0.506B · 과대 +1.126B.
      과대의 절반가량이 **기록 딜 0.5B 미만 소형 유닛 10기**에 몰려 있다.
