...
**캘리브레이션 (2026-08-14, MG 램프 곡선 착륙 후): 1.044x · 19/25**
(SR 1.122x · MG 1.176x · RL 1.035x · SMG 1.002x · AR 0.957x, 캐비엇 **3유닛** 제외 —
아스카가 들어왔다). 스크립트가 「추적 가능」으로 세는 항의 과대 합계 +1.824B / 과소 −0.381B.
램프 곡선 직전 값은 1.033x · 20/25 · MG 1.125x였다.
애니힐리오 코어 지름 실측이 들어오기 직전 값은 1.065x · 16/25였다(항목 1 참조).
...
**레이 아야나미는 넣기 전에 볼 것이 있다.** Anti A.T. Field 추가딜은 그녀의 주 페이로드인데
지금도 **1.039x로 과대**다. 같은 덱(덱3)에 아스카가 있으니 실기록에선 그 상태가 켜져
있었을 텐데도 그렇다 — 이 floor를 닫기 전에 그녀 안의 다른 과대 항을 먼저 찾아야 한다.
...
## 새 갭: 무기변형 세그먼트의 탄착군 — 기저 무기로 근사 중, 미측정 (2026-08-07)
...
- ~~**hit rate**~~ → **모델됨 (2026-08-07)**: 무기 탄착군을 통해 코어히트율로 소비된다
  ...
  항목 참고 — 엔진 능력은 풀렸지만 15슬러그 중 11은 아직 재인코딩 전이다.
