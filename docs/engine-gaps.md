...
**판정은 상관관계가 했다.** 수집된 차지 무기 **31정 중 26정이 60발/분**이고 벗어나는
다섯이 전부다 — 라플라스: 얼티메이트 히어로 300 · 네온: 비전 아이 300 · 리베랄리오
200 · 신데렐라 180 · 아니스: 스타 120. 그 다섯이 **정확히 Fienn이 인게임에서 「멈춤이
없다」고 확인한 넷**(`NO_CHARGE_MOTION_DELAY`) 더하기 신데렐라다. 점검한 18유닛 중 0으로
나온 넷이 하필 이 다섯 안에 들어갈 확률은 **C(5,4)/C(18,4) = 0.16%**다. 멈춤이 있는
무기는 그 멈춤에 걸리고, 없는 무기는 자기 연사에 걸린다 — **둘은 층이 아니라 대안**이라
같이 걸면 같은 대기를 두 번 센다.
