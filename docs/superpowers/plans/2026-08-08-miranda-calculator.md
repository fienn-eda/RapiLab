...
grant_stats를 안 넘기는 다른 호출자들은 오늘과 같이 아무것도 남기지 않는다."
```
...
# 기록된 두 top-N 룰을 가르는 스탯. 미란다의 다른 불릿들도 같은 스탯을 주지만
# (애장품 헬스업!의 자신 ATK, 웨이크업! 2번불릿의 자신 크확) 그것들은 top-N 룰이
# 아니라서 애초에 기록되지 않는다 - 그래서 이 두 줄로 충분하다.
