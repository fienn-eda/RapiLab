...
def test_crescendo_stacks_share_one_clock_and_reach_the_cap():
    """"stacks up to 5 times and lasts for 15 sec" is ONE clock every new stack
    restarts (the Raven ruling), not five independent 15-sec timers. She empties
    a magazine every ~8 sec, inside 15, so the chain holds and the count walks
    to the cap; the old reading settled at "fills per lifetime" - 2 - and left
