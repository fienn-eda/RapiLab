...
READINGS = (
    ...
    # 리베랄리오의 12.6시그마는 **알려진 보류**다. 흑련 차분(grant 11.146±0.174f)과
    # 이 간격이 함께 그녀 base를 88f로 가리키지만, Fienn 결정(2026-08-16)으로 엔진은
    # 수집 데이터의 1.5초(90f)를 그대로 쓴다 — docs/decisions.md. 버그가 아니다.
    ("liberalio [DOWN_Charge]", 1.5, (6.09,), 83.000, 0.159,
     "**단독** 재측정 n=35, 분포 81x2 82x9 83x11 84x13 (85f는 0회). "
     "12.6시그마는 알려진 보류 — base 88f 실측 대 데이터 90f (decisions.md)"),
