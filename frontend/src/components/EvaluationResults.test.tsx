...
const DECKS = [
  ...
  { deck: ['rouge', 'volume', 'mint', 'grave', 'noir'],
    total_damage: 50, burst_damage: 30, normal_attack_damage: 15, skill_damage: 5, hold_burst_slugs: [], hold_fire_slugs: [], tap_fire_slugs: [], partial_charge_slugs: [], partial_charge_full_rounds: {}, seating: {} },
]
...
const DECK = {
  ...
  skill_damage: 100, hold_burst_slugs: [], hold_fire_slugs: [], tap_fire_slugs: [], partial_charge_slugs: [], partial_charge_full_rounds: {}, seating: {},
}
