...
const DECKS = [
  { deck: ['liter', 'blanc', 'crown', 'modernia', 'privaty'],
    total_damage: 100, burst_damage: 60, normal_attack_damage: 30, skill_damage: 10, hold_burst_slugs: [], tap_fire_slugs: [], seating: {} },
  { deck: ['rouge', 'volume', 'mint', 'grave', 'noir'],
    total_damage: 50, burst_damage: 30, normal_attack_damage: 15, skill_damage: 5, hold_burst_slugs: [], tap_fire_slugs: [], seating: {} },
]
...
const DECK = {
  ...
  skill_damage: 100, hold_burst_slugs: [], tap_fire_slugs: [], seating: {},
}
