...
export const HELP = {
  ...
  draft: {
    ...
    seatHintWithDeckPick:
      '팔레트의 니케를 누르면 활성 덱(밝은 테두리)에 앉아요. 덱 이름을 누르면 활성 덱이 바뀌어요. 앉은 니케를 눌러 들고 다른 덱의 자리를 누르면 옮기거나 맞바꿔요. ',
    /** 끝 공백이 있다 - seatHintCommon이 뒤에 이어 붙는다. */
    seatHintSingleDeck: '팔레트의 니케를 누르면 자리에 앉아요. ',
    seatHintCommon:
      '덱에 앉은 니케를 누르면 들려요. 같은 자리를 다시 누르면 편성에서 빠져요. Esc로 취소해요. 슬롯은 소속만 나타내며, 버스트 순서는 엔진이 정해요.',
    tiersIntro:
